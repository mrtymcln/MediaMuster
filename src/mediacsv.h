...
/// MediaFile, 22 columns. Lives outside the window class so it can be
...
namespace MediaCsv
{
	...
	/// neutralised there); display columns route through MediaFile's
	/// helpers so the export and the table can't disagree.
