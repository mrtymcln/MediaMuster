...
export MM_REVIEW_EVIDENCE="$PWD/docs/reviews/2026-09-06-current-code/evidence"
...
import csv,hashlib
from pathlib import Path
manifest=Path('docs/reviews/2026-09-06-current-code/evidence/source-manifest.tsv')
