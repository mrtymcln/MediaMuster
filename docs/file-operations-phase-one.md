...
- **Move within a filesystem:** relocate the existing file with the native no-overwrite operation. The data is not recopied. Check its identity before and after, and record the original and destination locations.
