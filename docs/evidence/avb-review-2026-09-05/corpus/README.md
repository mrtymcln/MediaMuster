...
Qt CPU detection aborts with a false missing-NEON error under the restricted sandbox; the comparison driver was approved to run outside the sandbox. Inputs are opened read-only. Python bytecode writes are disabled.
